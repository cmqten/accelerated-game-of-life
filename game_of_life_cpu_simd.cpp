...
static inline void simulate_row_simd_16_e(char* grid, char* buf, int width, 
...
static inline void simulate_row_simd_16_g(char* grid, char* buf, int width, 
    int height, int y, int ynorth, int ysouth)
{
    int irow = y * width;
    int inorth = ynorth * width;
...
static void game_of_life_cpu_simd_16(char* grid, int width, int height, 
    int gens)
{
...
template <class T> 
static inline void simulate_row_simd_int_e(char* grid, char* buf, int width, 
    int height, int y, int ynorth, int ysouth)
{
...
template <class T> 
static inline void simulate_row_simd_int_g(char* grid, char* buf, int width, 
    int height, int y, int ynorth, int ysouth)
{
    int vec_len = sizeof(T);
    int irow = y * width;
...
template <class T>
static void game_of_life_cpu_simd_int(char* grid, int width, int height, 
    int gens)
{
    int vec_len = sizeof(T);
